...
import 'package:flutter_ui/presentation/components/chat/messgae/bubble.dart';
...
class ChatMessageItemState extends State<ChatMessageItem> {
  ...
  void initState() {
    ...
    mAudioAssetLeftList
        .add(Constant.ASSETS_IMG + "audio_animation_list_left_3.png");
  }
  ...
  Widget build(BuildContext context) {
    ...
    return new Container(
      ...
      child: widget.mMessage.isSend
          ? getSentMessageLayout(widget.mMessage.img)
          : getReceivedMessageLayout(
              widget.mMessage.img, widget.mMessage.createTime),
    );
  }
  ...
  Widget getItemContent(HrlMessage mMessage) {
    switch (mMessage.msgType) {
      ...
      case HrlMessageType.text:
        ...
        // return Html(data: '${(widget.mMessage as HrlTextMessage).text}',
        //     // softWrap: true,
        //     style: {
        //       "html": Style(color: Colors.black, fontSize: FontSize(14.0)),
        //     });
  ...
  Widget getSentMessageLayout(String img) {
    return Container(
  ...
  Widget getReceivedMessageLayout(String img, int creatTime) {
    return Container(
